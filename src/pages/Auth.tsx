...
import { Dumbbell, Mail, Lock, User, AlertCircle, Loader } from 'lucide-react';
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card-elevated p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Success Message */}
            {message && (
              <div className="flex items-center gap-2 p-3 bg-primary-green/10 border border-primary-green/50 rounded-lg text-primary-green text-sm">
                <AlertCircle size={16} />
                <span>{message}</span>
              </div>
            )}
              ...
              <>
                ...
                <div className="text-sm text-secondary">
                  ...
                  <button
                    ...
                    className="text-primary-blue hover:text-primary-blue/80 transition-colors font-medium"
                  >
                    Sign up
                  </button>
                </div>
